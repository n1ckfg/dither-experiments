...
// https://www.npmjs.com/package/glsl-luma
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float zoom = 0.35;
    vec3 g = vec3(grain(uv, iResolution * zoom, time));
